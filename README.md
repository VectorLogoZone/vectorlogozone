...
There is also an expanded search at [LogoSear.ch](https://logosear.ch/) website that searches through a bunch of [other open logo sources](https://logosear.ch/sources/index.html).

There are [tons](https://logosear.ch/alternatives/index.html) of other logo sites, but none met these basic requirements.
